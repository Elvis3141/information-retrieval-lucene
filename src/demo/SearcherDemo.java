...
package demo;// tested for lucene 7.7.2 and jdk13
    ...
    private void search(IndexSearcher indexSearcher, String field){
        try{
            ...
            while(line!=null && !line.equals("") && !line.equalsIgnoreCase("q")){
                ...
                TopDocs results = indexSearcher.search(query, 2);
                ...
                for(int i=0; i<hits.length; i++){
                    ...
                    System.out.println("\tScore "+hits[i].score +"\ttitle="+hitDoc.get("title")+"\tcaption:"+hitDoc.get("caption")
                            +"\tmesh:"+hitDoc.get("mesh"));
                }
                System.out.println("Enter query or 'q' to quit: ");
                System.out.print(">>");
                line = br.readLine();
